    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-6 shadow-2xl">
          ...
          <DriverList drivers={drivers} loading={loading} readOnly liveStatusByDriver={liveStatusByDriver} />
        </div>
...
const DriversListPage = ({ drivers, refreshDrivers, loading, liveStatusByDriver }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-6 shadow-2xl">
        ...
        <DriverList drivers={drivers} onUpdate={refreshDrivers} loading={loading} liveStatusByDriver={liveStatusByDriver} />
      </div>
    </div>
  );
};
